 ...
 */
public class AvgScoreMapReduce extends Configured implements Tool {

    private static final Logger logger = LoggerFactory.getLogger(AvgScoreMapReduce.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(AvgScoreMapReduce.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        args = MapReduceUtil.agrsIO(AvgScoreMapReduce.class, args);

        int ret = ToolRunner.run(new AvgScoreMapReduce(), args);
        System.exit(ret);
    }
} 